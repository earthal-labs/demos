import{D as e}from"./vec2-C5dJMieJ.js";import{c as t}from"./vec3f64-DIOQknMY.js";import{o as n}from"./vec2f64-IO40D2xB.js";import{t as r}from"./Float3PassUniform-YEiGS05C.js";import{n as i,t as a}from"./glsl-D85RBwKC.js";import{t as o}from"./Matrix4BindUniform-DnHs9Hq_.js";import{t as s}from"./FloatPassUniform-DeUP8HjM.js";import{o as c}from"./Slice.glsl-BqTbVez5.js";import{t as l}from"./Float2BindUniform-C6b2PHzh.js";import{t as u}from"./PositionOutsideClipSpace-CLdt_M-O.js";import{t as d}from"./ShaderBuilder-DEBj6tn_.js";import{t as f}from"./Texture2DUintPassUniform-B2S1A2cs.js";import{a as p,i as m,n as h,o as g,r as _,t as v}from"./QuaternionToRotationMatrix.glsl-gLTIJkSn.js";var y=class extends h{constructor(){super(...arguments),this.clipMinCameraRelative=t(),this.clipMaxCameraRelative=t(),this.minSplatRadius=-1}};function b(t){let{clippingEnabled:n,hasSlicePlane:h}=t,y=new d,{fragment:b,varyings:S,vertex:C}=y;S.add(`conic`,`vec3`),S.add(`gaussianLogAlphaCutoff`,`float`),S.add(`offsetFromCenter`,`vec2`),C.uniforms.add(new f(`splatOrderTexture`,e=>e.splatOrder),new f(`splatAtlasTexture`,e=>e.splatAtlas),new s(`minSplatRadius`,e=>e.minSplatRadius),new l(`inverseScreenSize`,({camera:t})=>e(x,1/t.fullWidth,1/t.fullHeight)),new o(`proj`,e=>e.camera.projectionMatrix),new o(`view`,e=>e.camera.viewMatrix),new l(`nearFar`,e=>e.camera.nearFar)),n&&C.uniforms.add(new r(`clipMin`,e=>e.clipMinCameraRelative),new r(`clipMax`,e=>e.clipMaxCameraRelative)),C.include(_),C.include(m),C.include(v),C.include(g),C.include(p),C.include(c,t),C.code.add(i`float safeClipW(float clipW) {
