import{a as e}from"./vec4f64-CoPQWrdw.js";import{t}from"./NoParameters-XZJ-8n06.js";import{n}from"./glsl-D85RBwKC.js";import{t as r}from"./Float4PassUniform-Cu2daSgY.js";import{t as i}from"./FloatPassUniform-DeUP8HjM.js";import{t as a}from"./Texture2DPassUniform-CiCHIiok.js";import{t as o}from"./ScreenSpacePass.glsl-9L-_X5OK.js";import{t as s}from"./ShaderBuilder-DEBj6tn_.js";var c=class extends t{constructor(){super(...arguments),this.borderColor=e()}};function l(){let e=new s;return e.include(o),e.outputs.add(`fragColor`,`vec4`,0),e.fragment.uniforms.add(new a(`colorTexture`,e=>e.color),new a(`cutVolume`,e=>e.cutVolume),new a(`fillVolume`,e=>e.fillVolume),new a(`cutFillMask`,e=>e.cutFillMask),new a(`depthTexture`,e=>e.sceneDepth),new a(`cutFillReferenceDepthTexture`,e=>e.referenceDepth),new i(`pixelRatio`,(e,t)=>t.camera.pixelRatio),new r(`borderColor`,e=>e.borderColor)).main.add(n`vec4 color = texture(colorTexture, uv, 0.0);
