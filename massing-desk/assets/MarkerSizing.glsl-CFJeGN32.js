import{C as e,S as t}from"./mat4-BL30OFHW.js";import{t as n}from"./mat4f64-E_FXCKxO.js";import{r}from"./vec4f64-CoPQWrdw.js";import{i,s as a}from"./enums-C3NXllrX.js";import{o,t as s}from"./Texture-DbRAl6mr.js";import{t as c}from"./Float3PassUniform-YEiGS05C.js";import{n as l,t as u}from"./glsl-D85RBwKC.js";import{n as d,r as f}from"./ScreenSizePerspective.glsl-DCyTAQMw.js";import{t as p}from"./FloatBindUniform-C4h6J6-v.js";import{t as m}from"./Matrix4DrawUniform-CQqS-mc3.js";import{i as h,t as g}from"./View.glsl-Ca9NFacb.js";import{t as _}from"./FloatPassUniform-DeUP8HjM.js";import{t as v}from"./VisualVariables.glsl-CdKm505L.js";import{t as y}from"./FloatsPassUniform-DfJ8EJ1F.js";import{t as b}from"./ManagedTexture-Ch83gxXE.js";var x=8;function S(n,r){let{vertex:i,attributes:a}=n;i.uniforms.add(new _(`intrinsicWidth`,e=>e.width));let{hasScreenSizePerspective:o,spherical:s}=r;o?(n.include(d,r),f(i),g(i,r),i.uniforms.add(new m(`inverseViewMatrix`,(n,r)=>t(C,e(C,r.camera.viewMatrix,n.origin)))),i.code.add(l`
...
return color;
}`),r.hasVVColor?(n.include(v,r),a.add(`colorFeatureAttribute`,`float`),i.code.add(l`vec4 getColor() {
