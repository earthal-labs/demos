import{n as e,t}from"./glsl-D85RBwKC.js";import{t as n}from"./FloatBindUniform-C4h6J6-v.js";import{t as r}from"./Matrix4BindUniform-DnHs9Hq_.js";import{i,n as a,r as o}from"./View.glsl-Ca9NFacb.js";import{t as s}from"./Float4PassUniform-Cu2daSgY.js";import{t as c}from"./Float4BindUniform-CcjALdTT.js";import{i as l}from"./Slice.glsl-BqTbVez5.js";import{t as u}from"./OutputHighlight.glsl-CfLvc4dK.js";import{t as d}from"./Float2BindUniform-C6b2PHzh.js";import{t as f}from"./PositionOutsideClipSpace-CLdt_M-O.js";import{t as p}from"./ColorConversion.glsl-C9xFjUmo.js";import{t as m}from"./Texture2DPassUniform-CiCHIiok.js";import{t as h}from"./ShaderBuilder-DEBj6tn_.js";import{t as g}from"./OutputColorHighlightOLID.glsl-BjIT55Ov.js";import{c as _,l as v,t as y,u as b}from"./MarkerSizing.glsl-CFJeGN32.js";function x(x){let S=new h,{space:C,anchor:w,hasTip:T,hasScreenSizePerspective:E}=x,D=C===2,O=C===1;S.attributes.add(`position`,`vec3`),S.vertex.inputs.add(`position`,()=>`position`),S.include(b,x),S.include(y,x);let{vertex:k,fragment:A,varyings:j}=S;a(k,x),S.attributes.add(`previousDelta`,`vec4`),S.attributes.add(`uv0`,`vec2`),j.add(`vColor`,`vec4`),j.add(`vpos`,`vec3`,{invariant:!0}),j.add(`vUV`,`vec2`),j.add(`vSize`,`float`),T&&j.add(`vLineWidth`,`float`),k.uniforms.add(new d(`nearFar`,({camera:e})=>e.nearFar),new c(`viewport`,({camera:e})=>e.fullViewport)).code.add(e`vec4 projectAndScale(vec4 pos) {
