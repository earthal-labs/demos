import{i as e}from"./tslib.es6-CR8o2qfQ.js";import{n as t}from"./InterleavedLayout-BNSRMF35.js";import{t as n}from"./olidUtils-QA0iI0lz.js";import{n as r,t as i}from"./glsl-D85RBwKC.js";import{t as a}from"./FloatBindUniform-C4h6J6-v.js";import{n as o,t as s}from"./View.glsl-Ca9NFacb.js";import{t as c}from"./Float4PassUniform-Cu2daSgY.js";import{n as l}from"./ShaderTechniqueConfiguration-Bdlpv2HB.js";import{i as u}from"./Slice.glsl-BqTbVez5.js";import{t as d}from"./ObjectAndLayerIdColor.glsl-UC9jbvaT.js";import{t as f}from"./VisualVariables.glsl-CdKm505L.js";import{t as p}from"./ColorConversion.glsl-C9xFjUmo.js";import{t as m}from"./ShaderBuilder-DEBj6tn_.js";import{t as h}from"./OutputColorHighlightOLID.glsl-BjIT55Ov.js";import{t as g}from"./Transform.glsl-ByRGlEcg.js";import{t as _}from"./VertexColor.glsl-DrV8C2l2.js";import{t as v}from"./TriangleTechniqueConfiguration-DXyHInnI.js";import{n as y,t as b}from"./Texture2DUintDrawUniform-BPrRxgbM.js";import{t as x}from"./TextureBackedBufferLayout-BuZTftdB.js";var S=class extends v{constructor(){super(...arguments),this.cullFace=0,this.style=0,this.emissionSource=0,this.hasVertexColors=!1,this.hasOccludees=!1,this.hasVVColor=!1,this.draped=!1,this.textureCoordinateType=0,this.discardInvisibleFragments=!0,this.writeDepth=!0,this.hasVVInstancing=!1,this.hasVVSize=!1,this.hasVVOpacity=!1,this.overlayEnabled=!1,this.snowCover=!1}};function C(e,t,n,r){return e.draped?null:e.hasVVColor?r:e.hasVertexColors?n:t}e([l({count:3})],S.prototype,`cullFace`,void 0),e([l({count:6})],S.prototype,`style`,void 0),e([l({count:8})],S.prototype,`emissionSource`,void 0),e([l()],S.prototype,`hasVertexColors`,void 0),e([l()],S.prototype,`hasOccludees`,void 0),e([l()],S.prototype,`hasVVColor`,void 0),e([l()],S.prototype,`draped`,void 0);function w(e){let r=t().vec3f(`position`).vec4f(`uvMapSpace`);return e.draped?e.hasVVColor?r.f32(`colorFeatureAttribute`):e.hasVertexColors&&r.vec4u8(`color`,{glNormalized:!0}):r.u32(`textureElementIndex`,{integer:!0}),n()&&r.vec4u8(`olidColor`),r.freeze()}var T=[{type:`mat3f32`,name:`boundingRect`}],E=new x(T),D=new x([...T,{type:`vec4unorm8`,name:`color`}]),O=new x([...T,{type:`f32`,name:`colorFeatureAttribute`}]);function k(e){return C(e,E,D,O)}var A=new b(`componentTextureBuffer`,e=>e.textureBuffer),j=new y({layout:E,itemIndexAttribute:`textureElementIndex`,bufferUniform:A}),M=new y({layout:D,itemIndexAttribute:`textureElementIndex`,bufferUniform:A}),N=new y({layout:O,itemIndexAttribute:`textureElementIndex`,bufferUniform:A,enableNaNSupport:!0});function P(e){return C(e,j,M,N)}var F=.70710678118,I=F,L=.08715574274,R=10,z=1;function B(e){let t=P(e),n=t!=null,l=new m;n&&l.include(t.TextureBackedBufferModule,e);let{vertex:v,fragment:y,attributes:b,varyings:x}=l,S=e.output===10;o(v,e),l.include(g);let C=``;n?(e.hasVVColor&&(C=t.getTextureAttribute(`colorFeatureAttribute`)),e.hasVertexColors?(l.varyings.add(`vColor`,`vec4`),l.vertex.code.add(r`void forwardVertexColor() { vColor = ${t.getTextureAttribute(`color`)}; }`)):l.vertex.code.add(r`void forwardVertexColor() {}`),b.add(`textureElementIndex`,`uint`)):(l.include(_,e),e.hasVVColor&&(b.add(`colorFeatureAttribute`,`float`),C=`colorFeatureAttribute`)),b.add(`position`,`vec3`),v.inputs.add(`position`,()=>`position`),l.include(f,e),l.include(d,e),y.include(u,e),l.include(h,e),e.draped&&v.uniforms.add(new a(`worldToScreenRatio`,e=>1/e.screenToPCSRatio)),b.add(`uvMapSpace`,`vec4`),e.hasVertexColors||x.add(`vColor`,`vec4`),x.add(`vpos`,`vec3`,{invariant:!0}),x.add(`vuv`,`vec2`),v.uniforms.add(new c(`uColor`,e=>e.color));let w=e.style===3||e.style===4||e.style===5;return w&&v.code.add(r`
      const mat2 rotate45 = mat2(${r.float(F)}, ${r.float(-.70710678118)},
                                 ${r.float(I)}, ${r.float(F)});
    `),!e.draped&&n&&(s(v,e),v.uniforms.add(new a(`worldToScreenPerDistanceRatio`,e=>1/e.camera.perScreenPixelRatio)),v.code.add(r`vec3 projectPointToLineSegment(vec3 center, vec3 halfVector, vec3 point) {
float projectedLength = dot(halfVector, point - center) / dot(halfVector, halfVector);
return center + halfVector * clamp(projectedLength, -1.0, 1.0);
}`),v.code.add(r`vec3 intersectRayPlane(vec3 rayDir, vec3 rayOrigin, vec3 planeNormal, vec3 planePoint) {
