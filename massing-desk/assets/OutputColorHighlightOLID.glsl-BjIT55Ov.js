import{f as e,o as t,r as n}from"./ShaderOutput-BpkC-wrv.js";import{n as r,t as i}from"./glsl-D85RBwKC.js";import{t as a}from"./OutputHighlight.glsl-CfLvc4dK.js";import{t as o}from"./ColorConversion.glsl-C9xFjUmo.js";import{t as s}from"./alphaCutoff.glsl-WbW_sSK3.js";import{t as c}from"./Emissions.glsl-COdKMm_s.js";import{n as l}from"./oitResolution.glsl-F61VOs5f.js";import{t as u}from"./EmissionDimming.glsl-Ck8FkUFl.js";import{t as d}from"./ditherNoise.glsl-UOpZ2vbN.js";function f(f,p){f.include(a,p),f.include(c,p);let{fragment:m,outputs:h}=f,{output:g,hasEmission:_,discardInvisibleFragments:v,oitPremultipliedAlpha:y,snowCover:b,useFloatBlend:x,emissionDimmingPass:S}=p,C=g===11,w=n(g),T=t(g),E=e(g)&&!w,D=0;(E||w)&&h.add(`fragColor`,`vec4`,D++),w&&h.add(`fragAlpha`,`float`,D++),_&&h.add(`fragEmission`,`vec4`,D++),m.include(o),m.include(s),m.include(l,p),m.include(d,p),S&&m.include(u,p),m.code.add(r`
