import{D as e}from"./vec2-C5dJMieJ.js";import{o as t}from"./vec2f64-IO40D2xB.js";import{n}from"./vec4f64-CoPQWrdw.js";import{n as r,t as i}from"./glsl-D85RBwKC.js";import{t as a}from"./ScreenSizePerspective.glsl-DCyTAQMw.js";import{t as o}from"./Float4PassUniform-Cu2daSgY.js";import{t as s}from"./Float4BindUniform-CcjALdTT.js";import{t as c}from"./FloatPassUniform-DeUP8HjM.js";import{n as l,t as u}from"./AlignPixel.glsl-4mP-nPTK.js";import{n as d}from"./Slice.glsl-BqTbVez5.js";import{t as f}from"./Float2BindUniform-C6b2PHzh.js";import{t as p}from"./Float2PassUniform-BYZ61_RB.js";import{t as m}from"./ShaderBuilder-DEBj6tn_.js";import{t as h}from"./OutputColorHighlightOLID.glsl-BjIT55Ov.js";function g(t){let g=new m,{vertex:y,fragment:b}=g;return y.include(u),g.include(l,t),g.vertex.include(d,t),t.hudDepth||g.include(h,t),g.attributes.add(`uv0`,`vec2`),y.uniforms.add(new s(`viewport`,e=>e.camera.fullViewport),new c(`lineSize`,(e,t)=>e.size>0?Math.max(1,e.size)*t.camera.pixelRatio:0),new f(`pixelToNDC`,t=>e(v,2/t.camera.fullViewport[2],2/t.camera.fullViewport[3])),new c(`borderSize`,(e,t)=>e.borderColor?t.camera.pixelRatio:0),new p(`screenOffset`,(t,n)=>e(v,t.horizontalScreenOffset*n.camera.pixelRatio,0))),g.varyings.add(`coverageSampling`,`vec4`),g.varyings.add(`lineSizes`,`vec2`),t.hasScreenSizePerspective&&a(y),y.main.add(r`
    ...
    gl_Position = projectedPosition;`),b.uniforms.add(new o(`uColor`,e=>e.color??n),new o(`borderColor`,e=>e.borderColor??n)),b.main.add(r`
