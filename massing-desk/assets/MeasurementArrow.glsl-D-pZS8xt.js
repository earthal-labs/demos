import{n as e}from"./glsl-D85RBwKC.js";import{n as t}from"./View.glsl-Ca9NFacb.js";import{t as n}from"./Float4PassUniform-Cu2daSgY.js";import{t as r}from"./FloatPassUniform-DeUP8HjM.js";import{t as i}from"./ShaderBuilder-DEBj6tn_.js";import{t as a}from"./OutputColorHighlightOLID.glsl-BjIT55Ov.js";function o(o){let s=new i,{vertex:c,fragment:l}=s;s.include(a,o),t(c,o),c.uniforms.add(new r(`width`,e=>e.width)),s.attributes.add(`position`,`vec3`),s.attributes.add(`normal`,`vec3`),s.attributes.add(`uv0`,`vec2`),s.attributes.add(`length`,`float`),s.varyings.add(`vtc`,`vec2`),s.varyings.add(`vlength`,`float`),s.varyings.add(`vradius`,`float`),c.main.add(e`vec3 bitangent = normal;
vtc = uv0;
vlength = length;
vradius = 0.5 * width;
