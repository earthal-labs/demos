import{t as e}from"./NoParameters-XZJ-8n06.js";import{n as t}from"./glsl-D85RBwKC.js";import{t as n}from"./FloatPassUniform-DeUP8HjM.js";import{t as r}from"./ReadDepth.glsl-Ca_0z8Pl.js";import{t as i}from"./Texture2DPassUniform-CiCHIiok.js";import{t as a}from"./ScreenSpacePass.glsl-9L-_X5OK.js";import{t as o}from"./ShaderBuilder-DEBj6tn_.js";import{t as s}from"./Texture2DDrawUniform-D7tKvlQx.js";import{t as c}from"./CameraSpace.glsl-DsLqHhLz.js";import{t as l}from"./GlobalIlluminationColorQuantization.glsl-DASwhWnI.js";import{t as u}from"./GlobalIlluminationWeights.glsl-Bk-lJUwL.js";var d=5e4,f=100,p=class extends e{};function m(){let e=new o,p=e.fragment;return e.include(a),e.include(c),e.include(u),p.include(r),p.include(l),p.uniforms.add(new i(`depthMap`,e=>e.depthTexture),new i(`normalMap`,e=>e.normalTexture),new s(`tex`,e=>e.colorTexture),new s(`globalIlluminationWeightTexture`,e=>e.weightTexture),new n(`projScale`,(e,t)=>{let n=t.camera.distance;return n>d?Math.max(0,e.projScale-(n-d)):e.projScale})),p.code.add(t`
