import{T as e}from"./mathUtils-D79yUFwW.js";import{f as t}from"./ShaderOutput-BpkC-wrv.js";import{t as n}from"./Uniform-FnPH-ujw.js";import{t as r}from"./Float3PassUniform-YEiGS05C.js";import{n as i,t as a}from"./glsl-D85RBwKC.js";import{t as o}from"./Float3DrawUniform-C2uWcyOr.js";import{t as s}from"./FloatPassUniform-DeUP8HjM.js";import{t as c}from"./Texture2DPassUniform-CiCHIiok.js";import{t as l}from"./Gamma.glsl-BiRghhbe.js";import{t as u}from"./Texture2DDrawUniform-D7tKvlQx.js";import"./oitResolution.glsl-F61VOs5f.js";function d(e,t){switch(t.textureCoordinateType){case 1:e.attributes.add(`uv0`,`vec2`),e.varyings.add(`vuv0`,`vec2`),e.vertex.code.add(i`void forwardTextureCoordinates() { vuv0 = uv0; }`);return;case 2:e.attributes.add(`uv0`,`vec2`),e.attributes.add(`uvRegion`,`vec4`),e.varyings.add(`vuv0`,`vec2`),e.varyings.add(`vuvRegion`,`vec4`),e.vertex.code.add(i`void forwardTextureCoordinates() {
vuv0 = uv0;
vuvRegion = uvRegion;
