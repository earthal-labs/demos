import{i as e}from"./tslib.es6-CR8o2qfQ.js";import{n as t,r as n,t as r}from"./Ellipsoid-Co4rBm1M.js";import{Y as i}from"./units-CeAMWm3z.js";import{T as a,l as o}from"./mathUtils-D79yUFwW.js";import{D as s}from"./vec2-C5dJMieJ.js";import{D as c}from"./vec3-CMyaVPVc.js";import{o as l}from"./vec2f64-IO40D2xB.js";import{t as u}from"./olidUtils-QA0iI0lz.js";import{f as d,u as ee}from"./ShaderOutput-BpkC-wrv.js";import{t as f}from"./Uniform-FnPH-ujw.js";import{n as p,t as m}from"./glsl-D85RBwKC.js";import{t as h}from"./Float3BindUniform-BmdF9XGj.js";import{t as g}from"./FloatBindUniform-C4h6J6-v.js";import{n as _,t as v}from"./ShaderTechniqueConfiguration-Bdlpv2HB.js";import{a as te}from"./Slice.glsl-BqTbVez5.js";import{t as ne}from"./OutputHighlight.glsl-CfLvc4dK.js";import{t as re}from"./Texture2DBindUniform-4_yYNByJ.js";import{t as y}from"./Float2BindUniform-C6b2PHzh.js";import{t as b}from"./ReadDepth.glsl-Ca_0z8Pl.js";import{t as x}from"./ShaderBuilder-DEBj6tn_.js";import{t as S}from"./alphaCutoff.glsl-WbW_sSK3.js";import{i as ie,n as C,r as w}from"./Emissions.glsl-COdKMm_s.js";import{t as T}from"./Texture2DDrawUniform-D7tKvlQx.js";import{n as E}from"./oitResolution.glsl-F61VOs5f.js";import{t as ae}from"./OutputColorHighlightOLID.glsl-BjIT55Ov.js";import{i as D,n as O}from"./VertexPosition.glsl-ljeW1mX9.js";import{a as k,n as A}from"./DiscardOrAdjustAlpha.glsl-C_6iZkfi.js";import{r as j}from"./ForwardLinearDepthToWriteShadowMap.glsl-CVZkqchq.js";import{t as M}from"./VertexColor.glsl-DrV8C2l2.js";import{t as oe}from"./OutputDepth.glsl-C_Yal9Dw.js";import{t as se}from"./ComputeNormalTexture.glsl-BsXBjjyq.js";import{r as N,t as P}from"./EvaluateSceneLighting.glsl-BEUwzYTR.js";import{n as ce,r as le}from"./MainLighting.glsl-BzpgU6pB.js";import{t as ue}from"./PiUtils.glsl-CpyVHJCx.js";import{n as de,t as F}from"./SnowCover.glsl-Dauiqufq.js";import{t as I}from"./ReadShadowMap.glsl-oFMVskK0.js";import{t as L}from"./MixExternalColor.glsl-cTOJOQI5.js";import{a as R,i as z,t as B}from"./OutputHighlightOverlay-CQGDw1Qk.js";import{n as V,t as H}from"./Texture2DUintDrawUniform-BPrRxgbM.js";import{i as U,m as W}from"./DefaultLayouts-CRwjrrN-.js";import{t as fe}from"./SphereIntersect.glsl-DoZEFl8k.js";function pe(e){e.vertex.code.add(p`
...
}`)}function xe(e,t){t.hasColorTexture&&(d(t.output)||t.alphaDiscardMode!==1)?(e.include(w,t),e.fragment.uniforms.add(new T(`baseColorTexture`,e=>e.texture,e=>e.textureSampler)).code.add(p`vec4 readBaseColorTexture() { return textureLookup(baseColorTexture, vuv0); }`)):e.fragment.code.add(p`vec4 readBaseColorTexture() { return vec4(1.0); }`)}var J=class extends f{constructor(e,t){super(e,`bool`,2,(n,r,i)=>n.setUniform1b(e,t(r,i)))}},Y=class extends v{constructor(){super(...arguments),this.ellipsoidMode=1}};function X(e,t){e.fragment.uniforms.add(new y(`cameraHeights`,e=>{let n=e.camera,r=c(n.eye),a=Math.sqrt(r),l=Z(t)*i,u=r-l*l,d=o(Q,we,a-l);return d=Math.min(d,.98),s(Se,d,u)}),new h(`cameraPosition`,e=>e.camera.eye)),e.fragment.include(fe),e.fragment.code.add(p`float sphereDepthInterpolate(vec3 worldRay, vec3 viewRay, float currentLinearDepth) {
