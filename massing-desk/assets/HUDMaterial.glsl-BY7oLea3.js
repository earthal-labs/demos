import{D as e,w as t}from"./vec2-C5dJMieJ.js";import{o as n}from"./vec2f64-IO40D2xB.js";import{n as r}from"./vec4f64-CoPQWrdw.js";import{f as i}from"./ShaderOutput-BpkC-wrv.js";import{n as a,t as o}from"./glsl-D85RBwKC.js";import{n as s,r as c,t as l}from"./ScreenSizePerspective.glsl-DCyTAQMw.js";import{i as u}from"./View.glsl-Ca9NFacb.js";import{t as d}from"./Float4PassUniform-Cu2daSgY.js";import{t as f}from"./Float4BindUniform-CcjALdTT.js";import{t as p}from"./FloatPassUniform-DeUP8HjM.js";import{n as m,t as h}from"./AlignPixel.glsl-4mP-nPTK.js";import{n as g}from"./Slice.glsl-BqTbVez5.js";import{t as _}from"./ObjectAndLayerIdColor.glsl-UC9jbvaT.js";import{t as v}from"./OutputHighlight.glsl-CfLvc4dK.js";import{t as y}from"./Texture2DBindUniform-4_yYNByJ.js";import{t as b}from"./ReadDepth.glsl-Ca_0z8Pl.js";import{t as x}from"./PositionOutsideClipSpace-CLdt_M-O.js";import{t as S}from"./VisualVariables.glsl-CdKm505L.js";import{t as ee}from"./ColorConversion.glsl-C9xFjUmo.js";import{t as C}from"./Float2PassUniform-BYZ61_RB.js";import{t as w}from"./IntegerPassUniform-DN8CxRD1.js";import{t as T}from"./Texture2DPassUniform-CiCHIiok.js";import{t as E}from"./ShaderBuilder-DEBj6tn_.js";import{n as D}from"./FocusAreaColorNode-Ckipho0o.js";import{t as O}from"./alphaCutoff.glsl-WbW_sSK3.js";import{t as k}from"./OutputColorHighlightOLID.glsl-BjIT55Ov.js";var A=e=>e?D[e]:0;function j(t){let n=new E;n.include(m,t),n.vertex.include(g,t);let{output:D,hasOcclusionTexture:j,signedDistanceFieldEnabled:F,pixelSnappingEnabled:L,hasEmission:R,hasScreenSizePerspective:z,debugDrawLabelBorder:B,hasVVSize:V,hasVVColor:H,hasRotation:U,occludedFragmentFade:W,sampleSignedDistanceFieldTexelCenter:G,hasVertexColor:K,hasVertexSize:q,hasVertexRotation:J,hasVertexUVi:Y}=t;n.include(s),n.include(S,t),n.include(_,t),n.include(k,t);let{vertex:X,fragment:Z}=n;Z.include(ee),Z.code.add(a`
  ...
  `),n.varyings.add(`vcolor`,`vec4`),n.varyings.add(`vtc`,`vec2`),n.varyings.add(`vsize`,`vec2`);let Q=D===10;X.uniforms.add(new f(`viewport`,e=>e.camera.fullViewport),new C(`screenOffset`,(t,n)=>e(P,2*t.screenOffset[0]*n.camera.pixelRatio,2*t.screenOffset[1]*n.camera.pixelRatio)),new C(`anchorPosition`,e=>N(e)),new d(`materialColor`,({color:e})=>e),new p(`materialRotation`,e=>e.rotation),new C(`materialSize`,e=>e.size),new T(`tex`,e=>e.texture)),u(X),F&&(X.uniforms.add(new d(`outlineColor`,e=>e.outlineColor)),Z.uniforms.add(new d(`outlineColor`,e=>M(e)?e.outlineColor:r),new p(`outlineSize`,e=>M(e)?e.outlineSize:0))),L&&X.include(h),z&&(c(X),l(X)),B&&n.varyings.add(`debugBorderCoords`,`vec4`),n.attributes.add(`uv0`,`vec2`),Y&&n.attributes.add(`uvi`,`vec4`),K&&n.attributes.add(`color`,`vec4`),q&&n.attributes.add(`size`,`vec2`),J&&n.attributes.add(`rotation`,`float`),(V||H)&&n.attributes.add(`featureAttribute`,`vec4`),X.main.add(a`
...
posProj = alignToPixelOrigin(posProj, viewport.zw);
    ...
    vsize = inputSize;
  `);let $=i(D)&&t.hasFocusAreaStyle&&!t.draped;switch(Z.uniforms.add(new T(`tex`,e=>e.texture)),$&&Z.uniforms.add(new w(`focusAreaStyle`,e=>A(e.focusAreaStyle))),W&&!Q&&(Z.include(b),Z.uniforms.add(new y(`depthMap`,e=>e.mainDepth),new p(`occludedOpacity`,e=>e.occludedFragmentOpacity?.value??1))),j&&Z.uniforms.add(new y(`texOcclusion`,e=>e.hudOcclusion?.attachment)),B?Z.main.add(`
...
discard;
      ...
      `);break;case 2:Z.main.add(`fragColor.rgb /= fragColor.a;`);break;case 11:Z.main.add(`outputObjectAndLayerIdColor();`);break;case 10:n.include(v,t),Z.main.add(`outputHighlight(false);`)}return n}function M(e){return e.outlineColor[3]>0&&e.outlineSize>0}function N(e){return e.textureIsSignedDistanceField?F(e.anchorPosition,e.distanceFieldBoundingBox,P):t(P,e.anchorPosition),P}var P=n();function F(t,n,r){e(r,t[0]*(n[2]-n[0])+n[0],t[1]*(n[3]-n[1])+n[1])}var I=.08,L=Object.freeze(Object.defineProperty({__proto__:null,anchorPosition:N,build:j},Symbol.toStringTag,{value:`Module`}));export{N as n,L as r,j as t};