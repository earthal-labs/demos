import{i as e}from"./time-BzYz5R50.js";import{t}from"./uid-tFVEb1ZF.js";import{n}from"./uuid-CxFjXsEJ.js";import{D as r}from"./vec2-C5dJMieJ.js";import{o as i}from"./vec2f64-IO40D2xB.js";import{a,n as o}from"./vec4f64-CoPQWrdw.js";import{l as s}from"./vec4-B-G2J025.js";import{i as c,s as l}from"./enums-C3NXllrX.js";import{o as u,t as d}from"./Texture-DbRAl6mr.js";import{n as f,t as p}from"./glsl-D85RBwKC.js";import{t as m}from"./FloatBindUniform-C4h6J6-v.js";import{t as h}from"./Matrix4BindUniform-DnHs9Hq_.js";import{i as g,n as _,t as v}from"./View.glsl-Ca9NFacb.js";import{t as y}from"./Float4PassUniform-Cu2daSgY.js";import{t as b}from"./Float4BindUniform-CcjALdTT.js";import{t as x}from"./FloatPassUniform-DeUP8HjM.js";import{i as ee}from"./Slice.glsl-BqTbVez5.js";import{t as te}from"./ObjectAndLayerIdColor.glsl-UC9jbvaT.js";import{t as S}from"./Float2BindUniform-C6b2PHzh.js";import{t as C}from"./PositionOutsideClipSpace-CLdt_M-O.js";import{t as w}from"./ColorConversion.glsl-C9xFjUmo.js";import{t as T}from"./Float2PassUniform-BYZ61_RB.js";import{t as E}from"./Texture2DPassUniform-CiCHIiok.js";import{t as D}from"./ShaderBuilder-DEBj6tn_.js";import{t as O}from"./alphaCutoff.glsl-WbW_sSK3.js";import{t as k}from"./OutputColorHighlightOLID.glsl-BjIT55Ov.js";import{t as A}from"./PiUtils.glsl-CpyVHJCx.js";import{t as j}from"./MixExternalColor.glsl-cTOJOQI5.js";import{c as M,l as ne,t as re,u as ie}from"./MarkerSizing.glsl-CFJeGN32.js";var N={dash:[4,3],dot:[1,3],"long-dash":[8,3],"short-dash":[4,1],"short-dot":[1,1]},P={dash:N.dash,"dash-dot":[...N.dash,...N.dot],dot:N.dot,"long-dash":N[`long-dash`],"long-dash-dot":[...N[`long-dash`],...N.dot],"long-dash-dot-dot":[...N[`long-dash`],...N.dot,...N.dot],none:null,"short-dash":N[`short-dash`],"short-dash-dot":[...N[`short-dash`],...N[`short-dot`]],"short-dash-dot-dot":[...N[`short-dash`],...N[`short-dot`],...N[`short-dot`]],"short-dot":N[`short-dot`],solid:null},F=8,I=class{constructor(e,t,r){this.image=e,this.width=t,this.length=r,this.uuid=n()}};function L(e){return e!=null&&`image`in e}function R(e,t){return e==null?e:{pattern:e.slice(),pixelRatio:t}}function z(e){return{pattern:[e,e],pixelRatio:2}}function B(e){switch(e?.type){case`style`:return V(e.style);case`image`:return new I(e.image,e.width,e.length);case void 0:case null:return null}return null}function V(e){return e==null?null:R(P[e],F)}var H=class{constructor(e,n,r){this._createTexture=e,this._parametersKey=n,this._repository=new Map,this._orphanCache=r.newCache(`procedural-texture-repository:${t()}`,e=>e.dispose())}destroy(){for(let{texture:e}of this._repository.values())e.dispose();this._repository.clear(),this._orphanCache.destroy()}swap(e,t=null){let n=this._acquire(e);return this.release(t),n}release(e){if(e==null)return;let t=this._parametersKey(e),n=this._repository.get(t);if(n&&(n.refCount--,n.refCount===0)){this._repository.delete(t);let{texture:e}=n;this._orphanCache.put(t,e)}}_acquire(e){if(e==null)return null;let t=this._parametersKey(e),n=this._repository.get(t);if(n)return n.refCount++,n.texture;let r=this._orphanCache.pop(t)??this._createTexture(e),i=new U(r);return this._repository.set(t,i),r}},U=class{constructor(e){this.texture=e,this.refCount=1}};function W(e,t){return new H(t=>{if(L(t))return J(e,t.image);let{data:n,textureSize:r}=G(t),i=new u(r,1);return i.dataType=l.FLOAT,i.pixelFormat=6403,i.internalFormat=c.R16F,i.wrapMode=10497,new d(e,i,n)},e=>L(e)?`image-${e.uuid}`:`${e.pattern.join(`,`)}-r${e.pixelRatio}`,t)}function G(e){let t=K(e),n=1/e.pixelRatio,r=q(e),i=[],a=1;for(let e of t){for(let t=0;t<e;t++){let r=a*(Math.min(t,e-1-t)+.5)*n;i.push(r)}a=-a}let o=Math.round(t[0]/2);return{data:new Float32Array([...i.slice(o),...i.slice(0,o)]),textureSize:r}}function K(e){return e.pattern.map(t=>Math.round(t*e.pixelRatio))}function q(e){if(e==null)return 1;let t=K(e);return Math.floor(t.reduce((e,t)=>e+t))}function J(e,t){let{data:n,width:r,height:i}=t,a=new u(r,i);return a.dataType=l.UNSIGNED_BYTE,a.pixelFormat=6408,a.internalFormat=c.RGBA8,a.wrapMode={s:10497,t:33071},a.hasMipmap=!0,a.samplingMode=9987,new d(e,a,n)}function ae(e){return e==null?o:e.length===4?e:s(oe,e[0],e[1],e[2],1)}var oe=a();function se(e,t){if(!t.stippleEnabled)return void e.fragment.code.add(f`float getStippleAlpha(float lineWidth) { return 1.0; }
...
vTransitionType = timeStamps.w;`),i===3&&c.constants.add(`decayRate`,`float`,2.3),c.code.add(f`
    float getTrailOpacity(float x) {
      ...
      ${fe(i)}
    }`),c.uniforms.add(new x(`timeElapsed`,e=>e.timeElapsed),new x(`trailLength`,e=>e.trailLength),new x(`speed`,e=>e.animationSpeed),new T(`startEndTime`,e=>r(pe,e.startTime,e.endTime))),c.constants.add(`fadeInTime`,`float`,Z),c.constants.add(`fadeOutTime`,`float`,X),c.constants.add(`incomingTransition`,`int`,0),c.constants.add(`outgoingTransition`,`int`,2),c.code.add(f`float fadeIn(float x) {
