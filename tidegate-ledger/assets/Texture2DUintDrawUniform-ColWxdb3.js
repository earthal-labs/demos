import{i as e}from"./tslib.es6-CR8o2qfQ.js";import{N as t}from"./decorators-C4awV8Sp.js";import{K as n}from"./BufferView-DrscDuge.js";import{r}from"./Util-BnWu4ZiT.js";import{n as i,r as a,t as o}from"./Uniform-DbW1Stte.js";import{i as s,r as c}from"./oitResolution.glsl-DK3fgwtq.js";import{t as l}from"./FloatBindUniform-DuYdEJ-p.js";function u(e){switch(e.elementType){case`float`:switch(e.elementCount){case 1:return a`float`;case 2:return a`vec2`;case 3:return a`vec3`;case 4:return a`vec4`;case 9:return a`mat3`;default:e.elementCount}break;case`int`:switch(e.elementCount){case 1:return a`int`;case 2:return a`ivec2`;case 3:return a`ivec3`;case 4:return a`ivec4`;case 9:throw Error(`Invalid element count 9 for type int`);default:e.elementCount}break;case`uint`:switch(e.elementCount){case 1:return a`uint`;case 2:return a`uvec2`;case 3:return a`uvec3`;case 4:return a`uvec4`;case 9:throw Error(`Invalid element count 9 for type uint`);default:e.elementCount}break;default:e.elementType}throw Error(`unsupported field`)}var d=new l(`constNaN`,()=>NaN,{supportsNaN:!0}),f=class extends c{constructor(e){super(),this.supportNaN=e}};function p(e,t){let n=t?.supportNaN;n&&(e.uniforms.add(d),e.code.add(a`bool bitsEncodeFloat16NaN(highp uint bits) {
...
}`),d.code.add(a`${v} ${b};`),d.main.add(a`${b} = ${y}(${i});`)}function N(e){let t=P(e);return e=>a`${t}.${e}`}function P(e){return`${e}ItemData`}var F={1:a`uint`,2:a`uvec2`,4:a`uvec4`},I={1:a`.x`,2:a`.xy`,4:``},L=class extends o{constructor(e,t){super(e,`usampler2D`,2,(n,r,i)=>n.bindTexture(e,t(r,i)))}};export{j as n,L as t};