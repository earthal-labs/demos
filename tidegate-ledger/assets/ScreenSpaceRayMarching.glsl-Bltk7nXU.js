import{n as e,r as t}from"./Uniform-DbW1Stte.js";import{t as n}from"./Float3BindUniform-pvPYdztI.js";import{t as r}from"./FloatBindUniform-DuYdEJ-p.js";import{t as i}from"./Matrix4BindUniform-B8qaJVmk.js";import{t as a}from"./Float2BindUniform-D0I--N8s.js";import{t as o}from"./Texture2DBindUniform-CKLq3hU-.js";import{t as s}from"./ReadDepth.glsl-CLTK5zoe.js";function c(e){e.uniforms.add(new n(`mainLightDirection`,e=>e.lighting.mainLight.direction))}function l(e){e.uniforms.add(new n(`mainLightIntensity`,e=>e.lighting.mainLight.intensity))}function u(e){c(e),l(e),e.code.add(t`vec3 applyShading(vec3 shadingNormal, float shadow) {
float dotVal = clamp(dot(shadingNormal, mainLightDirection), 0.0, 1.0);
return mainLightIntensity * ((1.0 - shadow) * dotVal);
}`)}function d(n,c){let l=n.fragment;l.include(s),l.uniforms.add(new a(`nearFar`,e=>e.camera.nearFar),new o(`depthMap`,e=>e.depth?.attachment),new i(`proj`,e=>e.camera.projectionMatrix),new r(`invResolutionHeight`,e=>1/e.camera.height),new i(`reprojectionMatrix`,e=>e.reprojection.matrix)).code.add(t`
  ...
  vec3 screenSpaceIntersectionWithLimits(
    ...
    for(int stepIndex = 0; stepIndex < rayMarchMaxStepsInt - 1; ++stepIndex) {
      ...
      ${e(!c.clampRayToScreen,`if (projectedPosition.x <= 0.0  || projectedPosition.x >= 1.0) {
        return vec3(projectedPosition, 0.0);
      }`)}
      ...
      ${e(c.clampRayToScreen,`projectedPosition = clamp(projectedPosition, vec2(0.0), vec2(0.999));`)}
    }
    return vec3(projectedPosition, 0.0);
  }
  ...
  vec3 screenSpaceIntersection(vec3 rayDirection, vec3 startPosition, vec3 viewDirection, vec3 normal, float rayStepOffset) {
    return screenSpaceIntersectionWithLimits(
      ...
      normal,
      rayStepOffset,
      ${t.float(c.rayMarchMaxReach)},
      ${t.float(c.rayMarchMaxSteps)}
    );
  }
