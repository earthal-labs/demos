import{n as e}from"./enums-CsvnPRfA.js";import{n as t,r as n}from"./Uniform-DbW1Stte.js";import{t as r}from"./ScreenSpacePass.glsl-D44B-ma7.js";import{t as i}from"./NoParameters-ZDc3QXO4.js";import{t as a}from"./ShaderBuilder-CGRMmuSM.js";import{t as o}from"./FloatPassUniform-BgZa4F-S.js";import{t as s}from"./Texture2DPassUniform-BH3IXb0x.js";import{t as c}from"./Matrix4BindUniform-B8qaJVmk.js";import{t as l}from"./Float2BindUniform-D0I--N8s.js";import{t as u}from"./Gamma.glsl-CGeucRMX.js";import{t as d}from"./Texture2DBindUniform-CKLq3hU-.js";import{n as f,t as p}from"./ReadDepth.glsl-CLTK5zoe.js";import{t as m}from"./CameraSpace.glsl-CKENT-VX.js";import{i as h,t as g}from"./ScreenSpaceRayMarching.glsl-Bltk7nXU.js";import{t as _}from"./GlobalIlluminationColorQuantization.glsl-Dve6--_N.js";function v(e){e.include(p),e.uniforms.add(new l(`zProjectionMapLastFrame`,e=>f(e.reprojection.lastFrameCamera))),e.code.add(n`float linearDepthFromTextureLastFrame(sampler2D depthTexture, vec2 uv) {
return linearizeDepth(depthFromTexture(depthTexture, uv), zProjectionMapLastFrame);
}`)}var y=.01,b=.008,x=.002,S=.5,C=.02,w=.1,T=.008,E=.012,D=.008,O=40,k=.095,A=.008,j=60,M=2,N=.0039,P=.25,F=.15,I=25,L=.15,R=.5,z=1,B=1,V=16,H=class extends i{constructor(){super(...arguments),this.projScale=1,this.scaleGlobalIllumination=1,this.accumulatedFrames=0,this.temporalSampleFrame=0,this.rayMarchMinReach=L,this.rayMarchMaxReach=R,this.rayMarchWorldReach=25,this.rayMarchMinReachEmissionWeight=1,this.rayMarchMaxReachEmissionWeight=1,this.rayMarchMaxSteps=16,this.colorBleedWeight=F}};function U(i){let l=new a,f=l.fragment;return l.include(r),l.include(m),h(f),f.include(v),f.include(u),f.include(_),l.include(g,i),f.uniforms.add(new s(`normalMap`,e=>e.normalTexture),new s(`depthMap`,e=>e.depthTexture),new d(`lastFrameColorTexture`,e=>e.reprojection.lastFrameColor?.getTexture()),new d(`lastFrameDepthTexture`,e=>e.reprojection.lastFrameDepth?.attachment),new d(`lastFrameGlobalIlluminationTexture`,e=>e.globalIllumination?.getTexture()),new d(`lastFrameGlobalIlluminationWeightTexture`,t=>t.globalIllumination?.getTexture(e)),new c(`reprojectionViewMatrix`,e=>e.reprojection.viewMatrix),new c(`view`,e=>e.camera.viewMatrix),new o(`accumulatedFrames`,e=>e.accumulatedFrames),new o(`temporalSampleFrame`,e=>e.temporalSampleFrame),new o(`scaleGlobalIllumination`,e=>e.scaleGlobalIllumination)),f.uniforms.add(new o(`rayMarchMinReach`,e=>e.rayMarchMinReach),new o(`rayMarchMaxReach`,e=>e.rayMarchMaxReach),new o(`rayMarchWorldReach`,e=>e.rayMarchWorldReach),new o(`rayMarchMinReachEmissionWeight`,e=>e.rayMarchMinReachEmissionWeight),new o(`rayMarchMaxReachEmissionWeight`,e=>e.rayMarchMaxReachEmissionWeight),new o(`rayMarchMaxSteps`,e=>e.rayMarchMaxSteps),new o(`colorBleedWeight`,e=>e.colorBleedWeight)),i.hasEmission&&f.uniforms.add(new d(`lastFrameEmissionTexture`,e=>e.reprojection.lastFrameEmission?.attachment)),f.code.add(n`
  ...
  `),l.outputs.add(`fragGlobalIllumination`,`vec4`,0),l.outputs.add(`fragWeight`,`float`,1),f.main.add(n`
    ...
    for (int i = 0; i < steps; ++i) {
      ...
      if (hit.z > 0.0) {
        ${t(i.hasColor,n`
          ...
          vec3 sourceEmission = ${t(i.hasEmission,`texture(lastFrameEmissionTexture, hitReprojectedCoordinate).xyz`,`vec3(0.0)`)};
